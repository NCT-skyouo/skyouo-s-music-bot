...
module.exports = {
    name: '8d',
    category: 'filter',
    description: '[Premium] Toggles 8D effect (works best on headphones or stereo speakers)',
    aliases: [],
    premium: true,
    run: async (bot, msg, args) => {
        try {
            ...
            return msg.channel.send({
                embeds: [new bot.MessageEmbed()
                    .setTitle('🎶 Successfully ' + (!Enabled ? 'enabled' : 'disabled') + ' 8D effect', msg.guild.iconURL())
                    .setColor('FFE023')
