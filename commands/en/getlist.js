...
module.exports = {
    name: 'getlist',
    category: 'list',
    description: 'Gets the information of the specified playlist',
    aliases: ['getls', 'gls'],
    slash: new SlashCommandBuilder()
        .setName('getlist')
        .setDescription('Gets the information of the specified playlist')
        .addStringOption(option => option.setName('name').setDescription('The playlist name you\'ve exported').setRequired(true)),
