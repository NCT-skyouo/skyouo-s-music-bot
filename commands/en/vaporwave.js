...
module.exports = {
    name: 'vaporwave',
    category: 'filter',
    description: '[Premium] Toggles vaporwave effect',
    aliases: ['vw', 'vwave'],
    premium: true,
    run: async (bot, msg, args) => {
        try {
            ...
            const vwEnabled = await bot.player.getQueue(msg.guild.id).filters.vaporwave
                ...
                embeds:
                    [
                        new bot.MessageEmbed()
                            .setTitle('🎶 Successfully ' + (!vwEnabled ? 'enabled' : 'disabled') + ' vaporwave effect', msg.guild.iconURL())
                            .setColor('FFE023')
