  ...
  run: async (bot, msg, args) => {
    ...
    return msg.channel.send(
      new MessageEmbed()
        ...
        .addField("改作 Kristen v5", "除非您以正規的方式獲取 Kristen v5 的源代碼, 否則您不得重製, 散佈, 再許可 Kristen v5.")
        ...
        .addField("無權規範", "本服務無權更改您伺服器相關之設定, 且**__包括但不限於__** 炸群, 修改伺服器頻道/類別名稱, 修改伺服器身份組權限, 倘若您發現本服務有相關情形, 請通知 NCT skyouo#4092.")
