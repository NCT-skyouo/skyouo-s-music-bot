module.exports = function () {
  var mod = {}
  mod.types = ["JSON", "MYSQL", "REDIS", "MONGO"]
  mod.provide = { "JSON": require("./src/storing/json"), "MYSQL": require("./src/storing/mysql"), "REDIS": require("./src/storing/redis"), "MONGO": require("./src/storing/mongo") }
  mod.nowUsing = null
